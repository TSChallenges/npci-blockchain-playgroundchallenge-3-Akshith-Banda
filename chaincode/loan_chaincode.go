...
// ApplyForLoan handles loan application request
...
// ApproveLoan changes the status of the loan application
...
// MakeRepayment processes the loan repayment
...
// CheckLoanBalance retrieves the loan details
func (c *LoanContract) CheckLoanBalance(ctx contractapi.TransactionContextInterface, loanID string) (*Loan, error) {
	...
	loanInfo := &Loan{}
	err = json.Unmarshal(data, loanInfo)
	if err != nil {
		return nil, err
	}
	return loanInfo, nil
